...
rm ./logs/multiarmed_bandits/epsilon_greedy*.json
rm ./logs/multiarmed_bandits/MAB_EG*.png
images=()
N=$1
X=$((${N}*640/1920))
Y=$((${N}*480/1080))
for i in 1 2 3
do
    ./build/multiarmed_bandits/MAB_epsilon_greedy -e 0.01 -a 10 -n 500 -s 1000 -j 20;
    ./build/multiarmed_bandits/MAB_epsilon_greedy -e 0.05 -a 10 -n 500 -s 1000 -j 20;
    ./build/multiarmed_bandits/MAB_epsilon_greedy -e 0.1 -a 10 -n 500 -s 1000 -j 20;
    ./build/multiarmed_bandits/MAB_epsilon_greedy -e 0.2 -a 10 -n 500 -s 1000 -j 20;
