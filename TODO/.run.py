...
BUILD_TARGETS = {
    "ucb": {
        "target": "MAB_ucb_po",
        "executable": ROOTDIR / Path("build/multiarmed_bandits/MAB_ucb_po"),
    },
    "epsilon_greedy": {
...
GeneralArgs = {
    ...
    "episodes": {"arg": "-n", "value": 500},
    "steps": {"arg": "-s", "value": 200},
    "stepsize": {"arg": "-j", "value": 10},
}
